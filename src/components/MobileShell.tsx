...
import { Wallet, LayoutDashboard, PieChart as PieIcon, LineChart as LineIcon, Plus, Info } from "lucide-react";
      ...
      <header className="sticky top-0 z-40 px-4 pt-4 pb-3">
        <div className="glass-strong rounded-3xl px-4 py-3 flex items-center justify-between shadow-glass">
          ...
          <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="glass-strong border-white/40 rounded-2xl w-60 text-xs">
